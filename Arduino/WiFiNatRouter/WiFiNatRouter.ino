...
#ifndef STASSID
#define STASSID "SINHA_NCBN"
#define STAPSK "19061969"
#define APSSID "ESPNatRouter"
#define APPSK "pappuhunu"
#endif
...
void setup() {
  ...
  if (ret == ERR_OK) {
    ...
    if (ret == ERR_OK) {
      Serial.printf("WiFi Network '%s' with ****** password is now NATed behind '%s'\n", APSSID, STASSID);
