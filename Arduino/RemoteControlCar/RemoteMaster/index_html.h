...
font-size: xx-large;">
    <h2 style="text-align:center">
        MOUSEBOT </h2>
    <p style="text-align: center; color: #0088ff;">
    ...
    <script>
        ...
        var connection = new WebSocket('ws://' + "{{IPADDRESS}}" + ':81/');
    ...
    <script>
        ...
        function resize() {
            ...
            // document.querySelector(".docwidth").innerHTML = width;
            if (width < 1000) {
                radius = 200;
            }
            else {
        ...
        function Draw(event) {
            ...
            if (paint) {
                ...
                let x_rel = Math.round((x_relative / radius) * 100);
                let y_rel = Math.round((y_relative / radius) * 100);
                ...
                send(x_rel, y_rel, speed, angle_in_degrees);
            }
        } 
    </script>
</body>
